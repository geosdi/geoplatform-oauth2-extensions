 ...
 *
 */
package org.geosdi.geoplatform.services.dropwizard.resources.secure.folder;
 ...
 */
public interface SecureFolderResource extends GPFolderResource {

    @Deprecated
    Long insertFolder(Principal principal,
            InsertFolderRequest insertFolderRequest) throws Exception;

    @Deprecated
    Long updateFolder(Principal principal, GPFolder folder) throws Exception;

    @Deprecated
    Boolean deleteFolder(Principal principal, Long folderID) throws Exception;

    Long saveFolderProperties(Principal principal, Long folderID,
            String folderName, boolean checked, boolean expanded)
            throws Exception;

    Long saveAddedFolderAndTreeModifications(Principal principal,
            WSAddFolderAndTreeModificationsRequest sftModificationRequest)
            throws Exception;

    Boolean saveDeletedFolderAndTreeModifications(Principal principal,
            WSDeleteFolderAndTreeModifications sdfModificationRequest)
            throws Exception;

    Boolean saveDragAndDropFolderAndTreeModifications(Principal principal,
            WSDDFolderAndTreeModifications sddfTreeModificationRequest)
            throws Exception;

    FolderDTO getShortFolder(Principal principal, Long folderID)
            throws Exception;
