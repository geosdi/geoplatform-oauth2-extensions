 ...
 */
public class OAuth2LayerTest extends OAuth2CoreServiceTest {

    private static final String urlServer = "http://www.geosdi.org/test_oauth2";
    private static final String newUrlServer = "http://www.geosdi.org/newtest_oauth2";
    private static final String spatialReferenceSystem = "Geographic coordinate system";
    // Raster Layer 1
    private static final String titleRaster1 = "raster_1_oauth2";
    private GPRasterLayer raster1 = null;
    private long idRaster1 = -1;
    // Vector Layer 1
    private static final String titleVector1 = "vector_1_oauth2";
    private GPVectorLayer vector1 = null;
    private long idVector1 = -1;
    // Raster Layer 2
    private static final String titleRaster2 = "raster_2_oauth2";
    private GPRasterLayer raster2 = null;
    private long idRaster2 = -1;
    // Vector Layer 2
    private static final String titleVector2 = "vector_2_oauth2";
    private GPVectorLayer vector2 = null;
    private long idVector2 = -1;
    // Raster Layer 3
    private static final String titleRaster3 = "raster_3_oauth2";
    // Vector Layer 3
    private static final String titleVector3 = "vector_3_oauth2";
    ...
    public void setUp() throws Exception {
        ...
        vector1 = oauth2CoreClientConnector.getVectorLayer(idVector1);
        //
        ...
        raster2 = oauth2CoreClientConnector.getRasterLayer(idRaster2);
        ...
        vector2 = oauth2CoreClientConnector.getVectorLayer(idVector2);
        //
    ...
    @Test
    public void testSecureAddLayers() throws Exception {
        List<Long> idList = this.addLayer3OAuth2();

        this.checkStateOAuth2(new int[]{8, 5, 4, 3, 2, 1}, new int[]{4, 2},
                "after add layers");

        GPLayer newRasterLayer3 = oauth2CoreClientConnector
                .getRasterLayer(idList.get(0));
        ...
        GPLayer newVectorLayer3 = oauth2CoreClientConnector
                .getVectorLayer(idList.get(1));
    ...
    @Test
    public void testSecureGetLayer() throws Exception {
        ShortLayerDTO shortRasterLayer1 = oauth2CoreClientConnector
                .getShortLayer(idRaster1);
        ...
        ShortLayerDTO shortVectorLayer1 = oauth2CoreClientConnector
                .getShortLayer(idVector1);
    ...
    @Test
    public void testSecureUpdateRasterLayer() throws Exception {
        final String titleLayerUpdated = "rasterLayerUpdated_rs";

        raster1.setTitle(titleLayerUpdated);

        oauth2CoreClientConnector.updateRasterLayer(raster1);
        ShortLayerDTO layerUpdated = oauth2CoreClientConnector
                .getShortLayer(idRaster1);
    ...
    @Test
    public void testSecureDeleteLayer() throws Exception {
        // Assert total number of folders stored into DB before delete            
        List<ShortLayerDTO> allLayersBeforeDelete = oauth2CoreClientConnector
                .getLayers(idProjectTest).getLayers();
        ...
        boolean erased = oauth2CoreClientConnector.deleteLayer(idRaster1);
        ...
        List<ShortLayerDTO> allLayersAfterDelete = oauth2CoreClientConnector
                .getLayers(idProjectTest).getLayers();
    ...
    @Test
    public void testSaveAndDeleteLayerAndTreeModifications() throws Exception {
        Map<Long, Integer> map = new HashMap<Long, Integer>();
        GPWebServiceMapData descendantsMapData = new GPWebServiceMapData();
        descendantsMapData.setDescendantsMap(map);

        int totalElementsOfProject = oauth2CoreClientConnector
        ...
        // Adding new layer to user's root folder B
        long idLayerToTest = oauth2CoreClientConnector
                .saveAddedLayerAndTreeModifications(
                        new WSAddLayerAndTreeModificationsRequest(
                                projectTest.getId(),
                                rootFolderB.getId(), layerToTest,
                                descendantsMapData));

        GPBBox bbox = oauth2CoreClientConnector.getBBox(idLayerToTest);
        logger.debug("\n@@@@@@@@@@@@@@@@@@@@@@@@ LAYER_BBOX : {}@@@@@@@@"
                + "@@@@@@@\n", bbox);

        GPLayerInfo li = oauth2CoreClientConnector.getLayerInfo(idLayerToTest);
        logger.debug("\n@@@@@@@@@@@@@@@@@@@@@@@ LAYER_INFO : {}@@@@@@@@@"
                + "@@@@@@@\n", li);

        GPLayerType layerType = oauth2CoreClientConnector
                .getLayerType(idLayerToTest);
        logger.debug("\n@@@@@@@@@@@@@@@@@@@@@@@ LAYER_TYPE : {}@@@@@@@@@"
                + "@@@@@@@\n", layerType);
        ...
        this.checkStateOAuth2(new int[]{7, 6, 5, 4, 2, 1}, new int[]{2, 3},
                "before removing");

        // Removing layer from user's root
        map.clear();
        map.put(idRootFolderB, 2);
        oauth2CoreClientConnector.saveDeletedLayerAndTreeModifications(
    ...
    @Test
    public void testSecureDragAndDropLayerOnSameParent() throws Exception {
        logger.trace("\n\t@@@ testSecureDragAndDropLayerOnSameParent @@@");
        Map<Long, Integer> map = new HashMap<Long, Integer>();
        GPWebServiceMapData descendantsMapData = new GPWebServiceMapData();
        descendantsMapData.setDescendantsMap(map);
        ...
        this.checkStateOAuth2(new int[]{6, 5, 4, 3, 1, 2}, new int[]{2, 2},
    ...
    @Test
    public void testSecureDragAndDropLayerOnDifferentFolder() throws Exception {
        logger.trace("\n\t@@@ testSecureDragAndDropLayerOnDifferentFolder @@@");
        Map<Long, Integer> map = new HashMap<Long, Integer>();
        GPWebServiceMapData descendantsMapData = new GPWebServiceMapData();
        descendantsMapData.setDescendantsMap(map);
        ...
        this.checkStateOAuth2(new int[]{6, 5, 3, 2, 1, 4}, new int[]{3, 1},
    ...
    @Test
    public void testSecureTransactionOnAddLayer() throws Exception {
        logger.trace("\n\t@@@ testSecureTransactionOnAddLayer @@@");
        Map<Long, Integer> map = new HashMap<Long, Integer>();
        GPWebServiceMapData descendantsMapData = new GPWebServiceMapData();
        descendantsMapData.setDescendantsMap(map);
        map.put(idRootFolderA, 3);
        try {
            ...
            oauth2CoreClientConnector.saveAddedLayerAndTreeModifications(
                    new WSAddLayerAndTreeModificationsRequest(
                            projectTest.getId(),
                            rootFolderA.getId(), raster, descendantsMapData));
            Assert.fail("Add layer must fail because title value is null");
        } catch (Exception e) {
            this.checkInitialStateOAuth2("transaction test");
        }
    }

    @Test
    public void testSecureTransactionOnRemoveAndAddLayer() throws Exception {
        logger.trace("\n\t@@@ testSecureTransactionOnRemoveAndAddLayer @@@");
        Map<Long, Integer> map = new HashMap<Long, Integer>();
        GPWebServiceMapData descendantsMapData = new GPWebServiceMapData();
        descendantsMapData.setDescendantsMap(map);
        map.put(idRootFolderA, 3);
    ...
    @Test
    public void testSecureGetShortLayer() throws Exception {
        ShortLayerDTO layer = oauth2CoreClientConnector.getShortLayer(idVector2);
    ...
    @Test
    public void testSecureGetBBox() throws Exception {
        GPBBox bbox = oauth2CoreClientConnector.getBBox(idVector1);
    ...
    @Test
    public void testSecureCorrectnessOnAddLayers() throws Exception {
        logger.trace("\n\t@@@ testSecureCorrectnessOnAddLayers @@@");
        Map<Long, Integer> map = new HashMap<Long, Integer>();
        GPWebServiceMapData descendantsMapData = new GPWebServiceMapData();
        descendantsMapData.setDescendantsMap(map);
        ...
        try {
            List<Long> longList = oauth2CoreClientConnector
                    .saveAddedLayersAndTreeModifications(
                            new WSAddLayersAndTreeModificationsRequest(
                                    projectTest.getId(), rootFolderA.getId(),
                                    arrayList,
                                    descendantsMapData)).getElements();
            Assert.fail("Test must fail because list of layers is empty");
        } catch (Exception ex) {
            this.checkInitialStateOAuth2("correctess on AddLayers");
        }
    }

    @Test
    public void testSecureGetLayerInfo() throws Exception {
        GPLayerInfo layerInfo = oauth2CoreClientConnector.getLayerInfo(idRaster2);
    ...
    @Test
    public void testSecureGetLayersDataSourceByProject() throws Exception {
        this.addLayer3OAuth2();

        List<String> list = oauth2CoreClientConnector.getLayersDataSourceByProjectID(
    ...
    @Test
    public void saveSecureCheckStatusLayerAndTreeModifications() throws Exception {
        Assert.assertTrue(oauth2CoreClientConnector
                .saveCheckStatusLayerAndTreeModifications(idRaster1, true));
    }
    ...
    private ArrayList<Long> addLayer3OAuth2() throws Exception {
        ...
        return (ArrayList<Long>) oauth2CoreClientConnector
                .saveAddedLayersAndTreeModifications(
                        new WSAddLayersAndTreeModificationsRequest(
                                projectTest.getId(),
                                rootFolderA.getId(), arrayList,
                                descendantsMapData))
                .getElements();
    }
    ...
    private void checkLayerDeletedRest(long idLayer) {
        try {
            oauth2CoreClientConnector.getShortLayer(idLayer);
