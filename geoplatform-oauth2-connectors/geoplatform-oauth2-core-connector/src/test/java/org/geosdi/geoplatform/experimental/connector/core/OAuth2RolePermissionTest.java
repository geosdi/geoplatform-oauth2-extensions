 ...
 */
public class OAuth2RolePermissionTest extends OAuth2CoreServiceTest {
    ...
    @Test
    public void updateSecureRolePermissionTest() throws Exception {
        ...
        Assert.assertTrue(oauth2CoreClientConnector.updateRolePermission(
                new WSPutRolePermissionRequest(userMapData,
                        GPRole.USER.getRole(), organizationNameRSTest)));

        GuiComponentsPermissionMapData wsUserMapData = oauth2CoreClientConnector
                .getRolePermission(GPRole.USER.getRole(), organizationNameRSTest);
        ...
        GuiComponentsPermissionMapData wsViewerMapData = oauth2CoreClientConnector
                .getRolePermission(GPRole.VIEWER.getRole(),
    ...
    @Test
    public void getAllSecureRolesTest() throws Exception {
        List<String> roles = oauth2CoreClientConnector
                .getAllRoles(organizationNameRSTest).getRoles();
        logger.trace("\n\n@@@@@@@@@@@@@@@@@@@@@@@@@@@@@ROLES_FOUND for {} ,"
    ...
    @Test
    public void getSecureRolePermissionTest() throws Exception {
        GuiComponentsPermissionMapData wsAdminMapData = oauth2CoreClientConnector
                .getRolePermission(GPRole.ADMIN.getRole(),
                        organizationNameRSTest);
    ...
    final void saveRolesOAuth2() throws Exception {
        Assert.assertTrue(oauth2CoreClientConnector
                .saveRole(new WSSaveRoleRequest(GPRole.ADMIN.getRole(),
                                organizationNameRSTest)));
        Assert.assertTrue(oauth2CoreClientConnector
                .saveRole(new WSSaveRoleRequest(GPRole.USER.getRole(),
                                organizationNameRSTest)));
        Assert.assertTrue(oauth2CoreClientConnector
                .saveRole(new WSSaveRoleRequest(GPRole.VIEWER.getRole(),
                                organizationNameRSTest)));
    }
