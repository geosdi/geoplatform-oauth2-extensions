 ...
 *
 */
package org.geosdi.geoplatform.experimental.dropwizard.auth.provider.exception;
...
public class OAuth2ExceptionProvider implements
        ExceptionMapper<GPExceptionFault> {

    private static final Logger logger = LoggerFactory.getLogger(
            OAuth2ExceptionProvider.class);
